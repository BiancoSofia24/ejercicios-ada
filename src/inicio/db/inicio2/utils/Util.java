...
public class Util {
	...
	public static String requestStringFromUser(Scanner scan, String attribute, String option) {
		System.out.print("Ingrese " + attribute + " del " + option + " -> ");
		return scan.next();
	}

	public static int requestIdFromUser(Scanner scan, String option, String action) {
		System.out.print("Ingrese id del " + option + " a " + action + " -> ");
		return scan.nextInt();
	}
